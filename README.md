...
**เวอร์ชัน 6 (วินิจฉัย): เก็บ HTTP status จากคำขอเล่นจริง — ยังไม่ยืนยันว่าแก้การเล่นได้**
...
เปิดผล **25-HD v6 • รายงานการเล่น** แล้วดูเรื่องย่อ/กดขยาย: จะแสดงรหัส HTTP, โฮสต์
...
รุ่นนี้เอา GET ตรวจ master ซ้ำของ v5 ออก ใช้ `getVideoInterceptor` สังเกตคำขอที่ตัวเล่นส่งจริง
ไม่เพิ่มคำขอ ไม่เปลี่ยน URL/headers/status/body และไม่เก็บ token, path, query หรือ response body ในรายงาน
...
ใช้กับตัวเล่นภายในแอป; Cast/ดาวน์โหลดและ extractor ที่มี source เป็น provider อื่นอาจไม่ผ่าน hook นี้
รายงานว่างจึงไม่ได้แปลว่าเครือข่ายปกติ บิลด์นี้เป็นการวินิจฉัย ไม่ใช่การยืนยันว่าเล่นได้แล้ว
