...
**เวอร์ชัน 3: ปรับภาพปกและเปิดรายละเอียดซีรีส์ที่ยังอ่านตอนไม่ได้; การเล่น ZMDB ยังไม่พร้อม**
...
**การเล่นวิดีโอและการเลือกรายการตอนใน ZMDB ยังไม่รองรับอย่างยืนยันได้** ซีรีส์ที่รายการตอนอยู่ภายนอกจะเปิดรายละเอียดได้ พร้อมข้อความในเรื่องย่อว่าให้เลือกตอนผ่านเบราว์เซอร์ โดยยังไม่มีรายการตอนให้เล่นในแอป
...
ไม่มีการยืนยันว่า ZMDB เล่นได้ใน Cloudstream และยังไม่สามารถอ่านปุ่มเลือกตอนจาก embed แบบ `type=tv`
รุ่น 3 ป้องกัน extractor ที่เกิด exception ข้าม HTML fallback แต่ยังไม่ได้เพิ่ม extractor สำหรับ ZMDB
