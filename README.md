...
**เวอร์ชัน 2: แก้รายการหน้าแรก/ค้นหา/รายละเอียดจาก HTML จริง; การเล่นยังอยู่ระหว่างพัฒนา**
...
เพิ่ม regression tests จาก HTML ที่จับจริง 5 กรณี ควบคู่กับ tests เดิม

**การเล่นวิดีโอและการเลือกรายการตอนใน ZMDB ยังไม่รองรับอย่างยืนยันได้** ซีรีส์ที่รายการตอนอยู่ภายนอกจะแจ้งข้อจำกัดตรง ๆ
...
รุ่น 2 แก้จาก DOM จริง พร้อมเก็บตัวอย่างใน `TwentyFiveHD/src/test/resources/25hd/`
ตัวเล่นที่พบคือ ZMDB ซึ่งแสดง Cloudflare security block ในเบราว์เซอร์ทดสอบ จึงหยุดตรวจที่ลิงก์ iframe
ไม่มีการยืนยันว่า ZMDB เล่นได้ใน Cloudstream และยังไม่สามารถอ่านรายการตอนจาก embed แบบ `type=tv`
